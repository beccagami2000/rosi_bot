...
// Pin Definitions
#define DCMOTORDRIVERA_PIN_ENABLE1	1
#define DCMOTORDRIVERA_PIN_IN1	0
#define DCMOTORDRIVERA_PIN_IN2	2
#define DCMOTORDRIVERA_PIN_ENABLE2	3
#define DCMOTORDRIVERA_PIN_IN3	4
#define DCMOTORDRIVERA_PIN_IN4	5 
...
void loop() 
{
   ...
   Serial.println(F("\n start"));
    ...
    dcMotorDriverA.setMotorB(100,1);
    delay(2000);
    Serial.println(F("\n stop"));
    //Stop both motors
